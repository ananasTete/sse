/**
 * mock-conversation-store.ts
 *
 * In-memory server-side store for conversations used in the mock API handlers.
 * This is intentionally separate from the client-side HTTP helpers
