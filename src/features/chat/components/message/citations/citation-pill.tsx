	...
	return (
		<HoverCard.Root closeDelay={180} openDelay={120}>
			<HoverCard.Trigger asChild>
				...
				>
					{sourceIcon ? (
						...
						<Globe className="size-3 text-lagoon-deep" />
					)}
			...
			<HoverCard.Portal>
				<HoverCard.Content
					align="start"
					className="z-30 w-72 rounded-[1.1rem] border border-line bg-surface-strong p-3 text-left shadow-[0_24px_70px_rgba(18,52,41,0.2)] backdrop-blur-xl data-[side=top]:animate-in data-[side=top]:fade-in-0 data-[side=top]:slide-in-from-bottom-1"
					side="top"
					sideOffset={12}
				>
					<a
					...
					>
						<span className="flex items-start justify-between gap-3">
							<span className="block text-sm font-semibold leading-5 text-sea-ink">
								{title}
							</span>
