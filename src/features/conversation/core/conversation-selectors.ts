...
type ConversationDomainReadState = Pick<
...
export function selectCurrentBranchMessageUuids(conversation: {
  domain: ConversationDomainReadState;
}): string[] {
  return (
...
export function selectSiblingUuids(
  conversation: { domain: ConversationDomainReadState },
  messageUuid: string,
): string[] | null {
